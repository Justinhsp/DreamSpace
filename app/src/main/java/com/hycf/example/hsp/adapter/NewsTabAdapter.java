...
import com.hycf.example.hsp.ui.activity.NewsDetailNormalActivity;
import com.hycf.example.hsp.ui.activity.NewsDetailPhotoActivity;
 ...
 * 新闻列表适配器
 */
public class NewsTabAdapter extends MultiItemRecycleViewAdapter<NewsSummary> {
     ...
     * 加载不同布局文件
     */
    public NewsTabAdapter(Context context, final List<NewsSummary> datas) {
    ...
    public void convert(ViewHolderHelper holder, NewsSummary newsSummary) {
        switch (holder.getLayoutId()) {
            case R.layout.item_news_normal:
    ...
    private void setItemValues(final ViewHolderHelper holder, final NewsSummary newsSummary, final int position) {
        ...
        holder.setOnClickListener(R.id.rl_root, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NewsDetailNormalActivity.startAction(mContext, holder.getView(R.id.news_summary_photo_iv), newsSummary.getPostid(), newsSummary.getImgsrc());
            }
        });
    }
    ...
    private void setPhotoItemValues(ViewHolderHelper holder, final NewsSummary newsSummary, int position) {
        ...
        holder.setOnClickListener(R.id.ll_root, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NewsDetailPhotoActivity.startAction(mContext, getPhotoDetail(newsSummary));
            }
        });
    }
