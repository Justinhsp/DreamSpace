...
import com.hycf.example.hsp.ui.weight.CommentDialog;
import com.hycf.example.hsp.ui.weight.CommentListView;
import com.hycf.example.hsp.ui.weight.ExpandableTextView;
import com.hycf.example.hsp.ui.weight.FavortListView;
import com.hycf.example.hsp.ui.weight.ISpanClick;
import com.hycf.example.hsp.ui.weight.MultiImageView;
 ...
 * 朋友圈ViewHolder
 */
public class CircleFriendHolder extends RecyclerView.ViewHolder {
    ...
    public CircleFriendHolder(View itemView, Context mContext, int type) {
        super(itemView);
     ...
     * @return
     */
    public static CircleFriendHolder create(Context context, int type) {
        CircleFriendHolder imageViewHolder = new CircleFriendHolder(LayoutInflater.from(context).inflate(R.layout.item_circle_list, null), context, type);
    ...
    private void initView() {
        ...
        switch (type) {
            case CircleFriendAdapter.ITEM_VIEW_TYPE_URL:// 链接view
                ...
                break;
            case CircleFriendAdapter.ITEM_VIEW_TYPE_IMAGE:// 图文view
            default:
     ...
     * @param position2
     */
    public void setData(CircleFriendPresenter mPresenter2, CircleItem circleItem2, final int position2){
        ...
        //距离
        tvAddressOrDistance.setText("深圳");
        ...
        //图片或链接显示
        switch (type) {
            case CircleFriendAdapter.ITEM_VIEW_TYPE_URL:// 处理链接动态的链接内容和和图片
                ...
                break;
            case CircleFriendAdapter.ITEM_VIEW_TYPE_IMAGE:// 处理图片
            default:
        ...
        headIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //跳到个人朋友圈
                ToastUitl.showShort("点击头像"+position);
            }
        });
